...
const httpCodes = {
  ...
  UNAUTORIZED: new HttpErrorModel_1.default(
    "unauthorized",
    "unauthorized",
    401
  ),
  ...
  INVALID_TOKEN: new HttpErrorModel_1.default(
    "invalid token",
    "invalid token",
    498
  ),
  UNPROCESSABLE: new HttpErrorModel_1.default(
    "Unprocessable Content",
    "Unprocessable Content ",
    422
  ),
  SERVICE_UNAVAILMABLE: new HttpErrorModel_1.default(
    "server",
    "Service Unavailable",
    503
  ),
